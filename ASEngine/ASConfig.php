...
define('WEBSITE_NAME', "http://localhost/aaa/");
...
define('PASSWORD_SALT', "KRUFoXuu/S738k9RVzrQVg"); //22 characters to be appended on first 7 characters that will be generated using PASSWORD_ info above
...
define('REGISTER_CONFIRM', "http://localhost/aaa/confirm.php"); 

define('REGISTER_PASSWORD_RESET', "http://localhost/aaa/passwordreset.php"); 
...
define('SOCIAL_CALLBACK_URI', "http://localhost/aaa/vendor/hybridauth/"); 
