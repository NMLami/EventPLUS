...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top" id="main-nav">
    ...
    <center><h1 id ="hd"><b>Register on Event</b></h1> </center>
...
<form id="form1" id="form1" action="" method="POST">
    ...
    <label class = "sssss">Team name
        <span class="small">Give the team name</span>
    </label>
<input type="text" name="name">
 <label class = "sssss">Team Leader
        <span class="small"></span>
    </label>
<input type="text" name="tname">
 <label class = "sssss">Team Members </label>
 <input type="text" name="message">

    <label class = "sssss">Institution
        <span class="small">Enter the Institution</span>
    </label>
<input type="text" name="inst">
   <label class = "sssss">Payment Info
        <span class="small"></span></label>
<input type="text" name="payment">
   <label class = "sssss">Contact of Team Leader
      ...
      <div class="container">
        <div class="row">
          <div class="col text-center py-5">
            <a href="view222.php" class="btn btn-outline-secondary">View Participant</a>
          </div>
        </div>
...
if(isset($_POST['ss'])){
    ...
    include"dbfile.php";
     ...
     echo    $name=$_POST['name'];
      ...
      echo   $inst=$_POST['inst'];		
     echo    $prize=$_POST['payment'];
      echo   $contact=$_POST['contact'];
                                                        // echo   $image=$_POST['image'];
    
$sql="INSERT INTO cuet(name,tname,message,inst,payment,contact) VALUES ('$name','$tname','$message','$inst','$payment','$contact');";
